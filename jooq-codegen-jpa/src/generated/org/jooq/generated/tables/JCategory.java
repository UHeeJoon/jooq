...
public class JCategory extends TableImpl<CategoryRecord> {
     ...
     */
    public final TableField<CategoryRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public FilmCategoryPath filmCategory() {
        if (_filmCategory == null)
            _filmCategory = new FilmCategoryPath(this, null, Keys.FKO1VE8MJM8CXF87G7R55W53RCJ.getInverseKey());
