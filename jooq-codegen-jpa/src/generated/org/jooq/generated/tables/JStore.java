...
public class JStore extends TableImpl<StoreRecord> {
     ...
     */
    public final TableField<StoreRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<ForeignKey<StoreRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FKP2SEN6OUWNLHT537CSK0KIP90, Keys.FK93ODD5QBXDCHJMAJ7QA84K8XP);
    }
    ...
    public AddressPath address() {
        if (_address == null)
            _address = new AddressPath(this, Keys.FKP2SEN6OUWNLHT537CSK0KIP90, null);
    ...
    public StaffPath staff() {
        if (_staff == null)
            _staff = new StaffPath(this, Keys.FK93ODD5QBXDCHJMAJ7QA84K8XP, null);
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, null, Keys.FK4B6XS77VAIJUP4S0Q2S06MVDO.getInverseKey());
    ...
    public InventoryPath inventory() {
        if (_inventory == null)
            _inventory = new InventoryPath(this, null, Keys.FKTDGY352S88SHLSDBHXQP5K9VK.getInverseKey());
