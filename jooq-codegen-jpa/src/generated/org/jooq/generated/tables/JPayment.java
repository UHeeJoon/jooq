...
public class JPayment extends TableImpl<PaymentRecord> {
     ...
     */
    public final TableField<PaymentRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<ForeignKey<PaymentRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FKBY2SKJF3OV608YB6NM16B49LG, Keys.FK6MA2J46GJBGGRP573UYA2UB45, Keys.FKR2KY59817R20R8FMB030PGW5P);
    }
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, Keys.FKBY2SKJF3OV608YB6NM16B49LG, null);
    ...
    public RentalPath rental() {
        if (_rental == null)
            _rental = new RentalPath(this, Keys.FK6MA2J46GJBGGRP573UYA2UB45, null);
    ...
    public StaffPath staff() {
        if (_staff == null)
            _staff = new StaffPath(this, Keys.FKR2KY59817R20R8FMB030PGW5P, null);
