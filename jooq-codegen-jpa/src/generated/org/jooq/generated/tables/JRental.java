...
public class JRental extends TableImpl<RentalRecord> {
     ...
     */
    public final TableField<RentalRecord, LocalDateTime> LAST_UPDATE = createField(DSL.name("LAST_UPDATE"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_FK_INVENTORY_ID);
    }
    ...
    public List<UniqueKey<RentalRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.RENTAL_DATE);
    }

    @Override
    public List<ForeignKey<RentalRecord, ?>> getReferences() {
        return Arrays.asList(Keys.FK7JF1F7B8W6JOTL5QW1KXN8114, Keys.FKHA0Q4DEOEJ14CTJWLNWGHDOI9, Keys.FKG5XHR8HE6BF3O2E4GL4FAWWR2);
    }
    ...
    public CustomerPath customer() {
        if (_customer == null)
            _customer = new CustomerPath(this, Keys.FK7JF1F7B8W6JOTL5QW1KXN8114, null);
    ...
    public InventoryPath inventory() {
        if (_inventory == null)
            _inventory = new InventoryPath(this, Keys.FKHA0Q4DEOEJ14CTJWLNWGHDOI9, null);
    ...
    public StaffPath staff() {
        if (_staff == null)
            _staff = new StaffPath(this, Keys.FKG5XHR8HE6BF3O2E4GL4FAWWR2, null);
    ...
    public PaymentPath payment() {
        if (_payment == null)
            _payment = new PaymentPath(this, null, Keys.FK6MA2J46GJBGGRP573UYA2UB45.getInverseKey());
